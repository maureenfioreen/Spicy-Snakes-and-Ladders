...
{
  new (message_memory) game::msg::GameStateMsg(_init);
}

void GameStateMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<game::msg::GameStateMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GameStateMsg_message_member_array[4] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(game::msg::GameStateMsg, game_message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<game::msg::GameStateMsg>()
{
  return &::game::msg::rosidl_typesupport_introspection_cpp::GameStateMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, game, msg, GameStateMsg)() {
  return &::game::msg::rosidl_typesupport_introspection_cpp::GameStateMsg_message_type_support_handle;
}
