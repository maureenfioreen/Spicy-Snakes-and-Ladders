...
#include "game/msg/detail/game_state_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const game::msg::GameStateMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<game::msg::GameStateMsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_game
const rosidl_message_type_support_t *
get_message_type_support_handle<game::msg::GameStateMsg>()
{
  return &game::msg::typesupport_fastrtps_cpp::_GameStateMsg__handle;
}
