...
static const _GameStateMsg_type_support_symbol_names_t _GameStateMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, game, msg, GameStateMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, game, msg, GameStateMsg)),
  }
};
...
{
  return &::game::msg::rosidl_typesupport_cpp::GameStateMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, game, msg, GameStateMsg)() {
  return get_message_type_support_handle<game::msg::GameStateMsg>();
}
