...
#ifndef CUSTOM_MSGS__SRV__DETAIL__PLAYER_MOVE__FUNCTIONS_H_
#define CUSTOM_MSGS__SRV__DETAIL__PLAYER_MOVE__FUNCTIONS_H_
...
/// Initialize srv/PlayerMove message.
/**
...
/// Finalize srv/PlayerMove message.
/**
...
/// Create srv/PlayerMove message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_msgs__srv__PlayerMove_Request__init().
...
/// Destroy srv/PlayerMove message.
/**
 * It calls
 * custom_msgs__srv__PlayerMove_Request__fini()
...
/// Check for srv/PlayerMove message equality.
/**
...
/// Initialize array of srv/PlayerMove messages.
/**
...
/// Finalize array of srv/PlayerMove messages.
/**
 * It calls
 * custom_msgs__srv__PlayerMove_Request__fini()
...
/// Create array of srv/PlayerMove messages.
/**
 * It allocates the memory for the array and calls
 * custom_msgs__srv__PlayerMove_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlayerMove messages.
/**
 * It calls
 * custom_msgs__srv__PlayerMove_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlayerMove message array equality.
/**
...
/// Copy an array of srv/PlayerMove messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_msgs__srv__PlayerMove_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It calls
 * custom_msgs__srv__PlayerMove_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It allocates the memory for the array and calls
 * custom_msgs__srv__PlayerMove_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs
...
/**
 * It calls
 * custom_msgs__srv__PlayerMove_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_MSGS__SRV__DETAIL__PLAYER_MOVE__FUNCTIONS_H_
