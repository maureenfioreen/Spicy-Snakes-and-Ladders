...
#ifndef CUSTOM_MSGS__MSG__DETAIL__GAME_STATE_MSG__FUNCTIONS_H_
#define CUSTOM_MSGS__MSG__DETAIL__GAME_STATE_MSG__FUNCTIONS_H_
 ...
 * calls
 * custom_msgs__msg__GameStateMsg__init().
...
/**
 * It calls
 * custom_msgs__msg__GameStateMsg__fini()
 ...
 * custom_msgs__msg__GameStateMsg__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_msgs__msg__GameStateMsg__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_MSGS__MSG__DETAIL__GAME_STATE_MSG__FUNCTIONS_H_
